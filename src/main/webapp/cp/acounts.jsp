...
<%@page import="com.free.webmarketing.dto.User"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.free.webmarketing.service.UserService"%>
	...
	<div id="navbar" class="navbar navbar-default          ace-save-state">
		<div class="navbar-container ace-save-state" id="navbar-container">
			...
			<div class="navbar-header pull-left">
				<a href="index.html" class="navbar-brand"> <small> <i></i>
						الشعار
				</small>
				</a>
			</div>
				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue dropdown-modal"><a
						data-toggle="dropdown" href="#" class="dropdown-toggle"> <span
							class="user-info"> <small>مرحبا ,</small>
						...
						<ul
							...
							<li><a href="profile.html"> <i
									class="ace-icon fa fa-user"></i> الحساب
							</a></li>
	...
	<div class="main-container ace-save-state" id="main-container">
		...
		<div id="sidebar"
			...
			<ul class="nav nav-list">
				...
				<!-- 							<span class="menu-text">المهام المطلوبه  </span> -->
				<!-- 						</a> -->
				...
				<li class=""><a href="acounts.jsp" class="dropdown-toggle">
				...
				<!-- 							<span class="menu-text"> الارباح  </span> -->
				...
				<!-- 							<span class="menu-text"> الخصوصيه </span> -->
				...
				<!-- 							<span class="menu-text"> المساعده  </span> -->
				<!-- 						</a> -->
		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						<li><i class="ace-icon fa fa-home home-icon"></i> <a href="#">الرئيسية</a>
						</li>
					...
					<div class="nav-search" id="nav-search">
						<form class="form-search">
							<span class="input-icon"> <input type="text"
								placeholder="البحث.... " class="nav-search-input"
							...
							<tr>
								...
								<td>
									<form action="../User/UserServlet" method="post">
										...
										<input type="hidden" value="<%=!user.getActive() %>" name="setTo" />
										 <input
											type="hidden"  name="put"
											value="active" />
										<button type="submit">
											<%=(user.getActive() ? "ايقاف التفعيل" : "تفعيل")%></button>
									</form>
								</td>
							</tr>
							<%
